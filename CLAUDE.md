...
### Testing
- `just test` — 202 Rust tests
- `just test-python` — 403 Python tests
- `just test-all` — both (605 total)
...
just test           # Run Rust tests (187)
just test-python    # Run Python tests (403)
just test-all       # Run both (590 total)
